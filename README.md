# ImplicitIntent-MAD
 ...
 Develop program to create a text field and a button “Navigate”. When you enter a website and press navigate button it should open google page using Implicit Intents.
